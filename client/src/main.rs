    ...
    match opts.command {
        RaydiumCpCommands::InitializePool {
            ...
            let initialize_pool_instr = initialize_pool_instr(
                ...
                gravex_swap::create_pool_fee_reveiver::id(),
                init_amount_0,
                init_amount_1,
                open_time,
            )?;
        ...
        RaydiumCpCommands::Deposit {
            ...
            let pool_state: gravex_swap::states::PoolState = program.account(pool_id)?;
            // load account
            ...
            // calculate amount
            let results = gravex_swap::curve::CurveCalculator::lp_tokens_to_trading_tokens(
                u128::from(lp_token_amount),
                u128::from(pool_state.lp_supply),
                u128::from(total_token_0_amount),
                u128::from(total_token_1_amount),
                gravex_swap::curve::RoundDirection::Ceiling,
            )
            .ok_or(gravex_swap::error::ErrorCode::ZeroTradingTokens)
            .unwrap();
            println!(
        ...
        RaydiumCpCommands::SwapBaseIn {
            ...
            let amm_config_state = deserialize_anchor_account::<gravex_swap::states::AmmConfig>(
            ...
            let (
                ...
                (
                    gravex_swap::curve::TradeDirection::ZeroForOne,
                ...
                (
                    gravex_swap::curve::TradeDirection::OneForZero,
                    total_token_1_amount,
                    total_token_0_amount,
                    user_input_token,
                    spl_associated_token_account::get_associated_token_address(
            ...
            let result = gravex_swap::curve::CurveCalculator::swap_base_input(
        ...
        RaydiumCpCommands::SwapBaseOut {
            ...
            let result = gravex_swap::curve::CurveCalculator::swap_base_output(
